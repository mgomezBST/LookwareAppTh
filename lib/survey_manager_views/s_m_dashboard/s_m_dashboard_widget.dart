...
import 's_m_dashboard_model.dart';
export 's_m_dashboard_model.dart';

class SMDashboardWidget extends StatefulWidget {
  const SMDashboardWidget({super.key});

  @override
  State<SMDashboardWidget> createState() => _SMDashboardWidgetState();
}

class _SMDashboardWidgetState extends State<SMDashboardWidget>
    with TickerProviderStateMixin {
  late SMDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SMDashboardModel());
            ...
            Align(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    context.pushNamed('SM-notifications');
                  },
                  child: const Icon(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 8.0),
                              child: AutoSizeText(
                                'Balance of effectiveness of the survey manager based on the total number of surveys.',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('SM-addSurvey');
                                      },
                                      child: Card(
                                        clipBehavior:
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 16.0, 3.0),
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FlutterFlowTheme.of(context).secondaryBackground,
