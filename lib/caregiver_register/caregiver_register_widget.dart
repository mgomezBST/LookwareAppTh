...
import 'caregiver_register_model.dart';
export 'caregiver_register_model.dart';

class CaregiverRegisterWidget extends StatefulWidget {
  const CaregiverRegisterWidget({super.key});

  @override
  State<CaregiverRegisterWidget> createState() =>
      _CaregiverRegisterWidgetState();
}

class _CaregiverRegisterWidgetState extends State<CaregiverRegisterWidget> {
  late CaregiverRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CaregiverRegisterModel());
