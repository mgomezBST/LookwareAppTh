        ...
        body: Align(
          ...
          child: Padding(
            ...
            child: Container(
              ...
              height: MediaQuery.sizeOf(context).height * 0.779,
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            widget.clientDetails?.clientFirstName,
                            '-',
                          ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        widget.clientDetails?.insuranceCo,
                                        '-',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        widget.clientDetails?.caregiverName,
                                        '-',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        widget
                                            .clientDetails?.caregiverRelation,
                                        '-',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        widget.clientDetails?.caregiverEmail,
                                        '-',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        widget.clientDetails?.caregiverPhone,
                                        '-',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
