...
import 'request_machines_model.dart';
export 'request_machines_model.dart';

class RequestMachinesWidget extends StatefulWidget {
  const RequestMachinesWidget({
    super.key,
    String? title,
  ...
  @override
  State<RequestMachinesWidget> createState() => _RequestMachinesWidgetState();
}

class _RequestMachinesWidgetState extends State<RequestMachinesWidget> {
  late RequestMachinesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestMachinesModel());

    _model.yourNameTextController1 ??= TextEditingController();
    _model.yourNameFocusNode1 ??= FocusNode();

    _model.yourNameTextController2 ??= TextEditingController(text: '...');
