                              ...
                              Padding(
                                ...
                                child: StreamBuilder<List<PsdRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<PsdRecord> psdPsdRecordList =
                                        snapshot.data!;

                                    return FlutterFlowDropDown<String>(
                                      controller: _model.psdValueController ??=
                                          FormFieldController<String>(null),
                                      options: psdPsdRecordList
                                          .map((e) => e.idPsd)
                                          .toList(),
                                      onChanged: (val) =>
                                          setState(() => _model.psdValue = val),
                                      height: 50.0,
                                      textStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                  ...
                                  onPressed: () async {
                                    await SessionsRecord.collection
                                        ...
                                        .set(createSessionsRecordData(
                                          ...
                                          time: _model.timeValue,
                                          therapist: currentUserUid,
                                        ));

                                    await FFAppState()
                                        .hourReserved!
                                        .update(createHoursRecordData(
                                          reserva: true,
                                        ));
                                    await showDialog(
                                      context: context,
