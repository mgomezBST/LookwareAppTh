...
import 'policy_hipaa_model.dart';
export 'policy_hipaa_model.dart';

class PolicyHipaaWidget extends StatefulWidget {
  const PolicyHipaaWidget({super.key});

  @override
  State<PolicyHipaaWidget> createState() => _PolicyHipaaWidgetState();
}

class _PolicyHipaaWidgetState extends State<PolicyHipaaWidget> {
  late PolicyHipaaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PolicyHipaaModel());
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'BioStream Technologies (\"BST\") \n\nNotice of Privacy Practices under the HIPAA Privacy Rule\n',
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text:
                                'PLEASE CAFEFULLY REVIEW THIS NOTICE OF PRIVACY PRACTICES UNDER THE HIPAA PRIVACY RULE. ',
                          ...
                          const TextSpan(
                            text:
                                'When you submit information to or through BST Apps, Services or Website(s), you consent to the collection and processing of your information as described in this Notice of Privacy Practices under the HIPAA Privacy Rule.\n',
                            style: TextStyle(),
                          )
                        ],
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
