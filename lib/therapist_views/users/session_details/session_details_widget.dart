...
class SessionDetailsWidget extends StatefulWidget {
  ...
  final SessionsRecord? sessionsDetails;
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            if (FFAppState().reschedule ==
                                                false)
                                              Text(
                                                valueOrDefault<String>(
                                                  widget
                                                      .sessionsDetails?.center,
                                                  '-',
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                            ...
                            if (FFAppState().reschedule == true)
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.sessionsDetails!.reference
                                          .update(createSessionsRecordData(
                                        center: _model.dropDownValue1,
                                        time: _model.dropDownValue2,
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: const Text(
                                                'The session has been successfully rescheduled.'),
                                            actions: [
                                              TextButton(
                            ...
                            if (FFAppState().reschedule == false)
                              Align(
                                alignment: const AlignmentDirectional(0.0, 0.0),
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
